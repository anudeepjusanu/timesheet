(function () {
    ...
    function TeamReimbursementsController(UserService, _, $uibModal, $filter, $state) {
        var vm = this;
        vm.user = {};
        ...
        vm.openTeamReimbursementModal = function () {
            var modalInstance = $uibModal.open({
                animation: true,
                ariaLabelledBy: 'modal-title',
                ariaDescribedBy: 'modal-body',
    ...
    function AddMyReimbursementController(UserService, $scope, $timeout, _, $filter, $state) {
        var vm = this;
        vm.user = {};
        vm.categories = [
    ...
    function TeamReimbursementsModalController(UserService, _, $uibModal, $uibModalInstance, $filter, $state) {
        var vm = this;
        vm.user = {};
        vm.myReimbursementsObj = {
            items: []
