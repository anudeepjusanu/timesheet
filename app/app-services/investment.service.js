(function () {
    ...
    angular
        .module('app')
        .factory('InvestmentService', InvestmentService);

    function InvestmentService($http, $q) {
        var service = {};
        service.getMyInvestmentForm = getMyInvestmentForm;
        service.getInvestments = getInvestments;
        ...
        function getMyInvestmentForm(empId) {
            return $http.get('./app-services/json/config.json').then(handleSuccess, handleError);
        }

        function getInvestments(){
            return $http.get('./app-services/json/getInvestments.json').then(handleSuccess, handleError);
