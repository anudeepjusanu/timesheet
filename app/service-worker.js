...
! function(e) {
    ...
    return function e(t, n, r) {
        ...
        1: [function(e, t, n) {
            ...
            function l(e, t, n) { if (!e) return !1; if (t) { var r = e.headers.get("date"); if (r) { var o = new Date(r); if (o.getTime() + 1e3 * t < n) return !1 } } return !0 }
            var d, m = e("./options"),
        ...
        11: [function(e, t, n) {
            ...
            function r(e, t, n) {
                ...
                return i.debug("Strategy: network first [" + e.url + "]", n), i.openCache(n).then(function(t) {
                    ...
                    var h = i.fetchAndCache(e, n).then(function(e) { if (s && clearTimeout(s), r.test(e.status)) return e; throw i.debug("Response was an HTTP error: " + e.statusText, n), a = e, new Error("Bad response") }).catch(function(r) { return i.debug("Network or response error, fallback to cache [" + e.url + "]", n), t.match(e).then(function(e) { if (e) return e; if (a) return a; throw r }) });
        ...
        13: [function(e, t, n) {
            ...
            var r = e("./options"),
                ...
                c = e("./strategies"),
                s = e("./listeners");
            i.debug("Service Worker Toolbox is loading"), self.addEventListener("install", s.installListener), self.addEventListener("activate", s.activateListener), t.exports = { networkOnly: c.networkOnly, networkFirst: c.networkFirst, cacheOnly: c.cacheOnly, cacheFirst: c.cacheFirst, fastest: c.fastest, router: o, options: r, cache: i.cache, uncache: i.uncache, precache: i.precache }
...
var PrecacheConfig = [
    ...
    ["app-content/theme.css", "cb216223674d99e8b045baa5ff338bc2"],
    ["app-content/wavelabs.css", "acf350f069d86f8fb6ea4a07f5429846"],
    ["app.js", "b3650b6dbe8af02ab4491fd88817a608"],
    ["bower.json", "f270354464513e9081e099eafdce7680"],
    ["firebase-messaging-sw.js", "a0f02b8287eb0491b8518c6a898b0d03"],
    ["index.html", "f564d8c84fc6b728907f9a2bb7d05cb3"],
    ["manifest.json", "e0651309a78b959d9ccdb6f2a745860d"],
    ["npm-debug.log", "f6d3a19c7512ad398c3dc66a07487806"],
    ["runtime-caching.js", "f9299b06f80acf929fc23ccadaf7df19"],
...
toolbox.router.get('http://localhost:8080/api/*', self.toolbox.networkOnly);